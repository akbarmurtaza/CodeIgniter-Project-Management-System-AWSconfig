...
$conn = new mysqli($servername, $username, $password, $dbname);
  ...
  if(isset($_POST['input']))
    {
  $sql = "INSERT INTO interneeattendance VALUES('$date_today','$id','Yes','Present','$time')";
...
<div class="container" style="left:80px;position:relative;">
  <h3 align="center"> Mark Internee Attendance </h3>
  <br>
  <br>
<div class="col-xs-8" align="left">
  ...
  <select class="form-control input-sm" name="id" id="lead_id"  required/>
                     <option value="" selected disabled>----Select Internee----</option>
